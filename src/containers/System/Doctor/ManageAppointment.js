...
class ManageAppointment extends Component {
  ...
  handleCancel = async () => {
    ...
    let res = await cancelAppointment({
      ...
      date: item.date,
      timeType: item.timeType,
      emailPatient: item.bookingData.email,
      firstNamePatient: item.bookingData.firstName,
      lastNamePatient: item.bookingData.lastName,
      firstNameDoctor: this.props.userInfo.firstName,
      lastNameDoctor: this.props.userInfo.lastName,
      timeBooking: item.timeBookingData.valueVi,
      dateBooking: this.buildTimeBooking(item.date),
    });
    this.setState({
      isLoading: false,
    });
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <div>
                            ...
                            <button
                              className="btn btn-cancel btn-cancel-appointment"
